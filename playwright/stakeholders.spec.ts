...
test.describe("Stakeholders", () => {
  ...
  test("should remove stakeholder from task", async ({ page }) => {
    ...
    const badge = sidebar
      .getByText(/to remove stakeholder/i)
      .first()
      .locator("..");
  ...
  test("should add stakeholder to comment", async ({ page }) => {
    ...
    const stakeholderSelect = commentsSection.getByRole("combobox", {
      name: /select stakeholder/i,
    });
    ...
    await page
      .getByRole("option", { name: /create.*comment stakeholder/i })
      .last()
      .click();
  ...
  test("should edit comment stakeholder", async ({ page }) => {
    ...
    await page
      .getByRole("option", { name: /create.*original stakeholder/i })
      .last()
      .click();
    ...
    const editForm = sidebar
      .locator("div.rounded-lg.border")
      .filter({ hasText: /comment to edit/i })
      .first();
    ...
    await page
      .getByRole("option", { name: /create.*updated stakeholder/i })
      .last()
      .click();
