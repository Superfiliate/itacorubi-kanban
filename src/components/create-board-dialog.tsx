    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Give your board a title and set a password to protect it. Both fields have been prefilled with suggestions, but you can change them.
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                This password will be required to access the board. Make sure to save it or share it with collaborators.
              </p>
            </div>
          </div>
